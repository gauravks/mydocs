...
This paper captures an overview of ideas, techniques, results and future possibilities of clustering in vehicular networks.
Clustering is a technique to group nodes based on a selected criteria
which defines certain level of similarities among the nodes.
Grouping the nodes together in such a way helps define or design certain set of functionalities which can only be applicable to the
groups and can be applied to smaller sub-set.
In a vehicular networking environment clustering can be used to group vehicles to reduce the network traffic and achieve better network throughput.

Clustering in vehicular network is 
